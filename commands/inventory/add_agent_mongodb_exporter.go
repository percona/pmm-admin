...
TLS            : {{ .Agent.TLS }}
TLS Skip Verify: {{ .Agent.TLSSkipVerify }}
`)
...
func init() {
	...
	AddAgentMongodbExporterC.Flag("tls-skip-verify", "Skip TLS/SSL certificates validation").BoolVar(&AddAgentMongodbExporter.TLSSkipVerify)
}
