...
func init() {
	...
	AddAgentProxysqlExporterC.Arg("username", "MySQL username for scraping metrics").Default("root").StringVar(&AddAgentProxysqlExporter.Username)
	AddAgentProxysqlExporterC.Flag("password", "MySQL password for scraping metrics").StringVar(&AddAgentProxysqlExporter.Password)
